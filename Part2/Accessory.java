public class Accessory extends HorseCondition{
    ...
    public static final Accessory BLINDERS = new Accessory("Blinders",0.0, 1.5, 0);
    ...
    public static final Accessory LEG_WRAPS = new Accessory("Leg Wraps",1.0, 1.0, 0); 
    public static final Accessory TOP_HAT = new Accessory("Top Hat",-1.0, 2.0, 0); 
