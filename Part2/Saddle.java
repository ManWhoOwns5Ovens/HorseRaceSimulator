public class Saddle extends HorseCondition{
    ...
    public static final Saddle RACING = new Saddle("Racing",1.0, 0.67, -5);
    public static final Saddle ENDURANCE = new Saddle("Endurance",-1.0, 1.5, 5); 
    public static final Saddle WESTERN = new Saddle("Western",-1.0, 1.5, 0); 
    public static final Saddle JUMPING = new Saddle("Jumping",0.0, 1.0, 5); 
